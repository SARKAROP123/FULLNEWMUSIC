...
OWNER_USERNAME = getenv("OWNER_USERNAME","ll_SARKAR_BABE_ll")
...
EVALOP = list(map(int, getenv("EVALOP", "6837107828").split()))
...
OWNER_ID = int(getenv("OWNER_ID", 6837107828))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/SARKAROP123/FULLNEWMUSIC",
)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/TKS_CHAT_GROUP_OP")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/8447f80bc5997dcc9763a.jpg"
)
PING_IMG_URL = getenv(
