...
@app.on_message(filters.command(["tagall", "spam", "tagmember", "tag", "stag", "hftag", "bstag", "eftag", "tag", "etag", "tag", "tag"], prefixes=["/", "@", "#"]))
...
@app.on_message(filters.command(["cancel", "tagstop"]))
